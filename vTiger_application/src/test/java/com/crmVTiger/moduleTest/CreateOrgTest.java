...
/**
 * Test script for Create organization module
 * @author Anshika
 */
...
public class CreateOrgTest extends BaseClass {
	...
	/**
	 * Scenarios 1: Login()--> navigate to Organization-->create new orgnization-->verify
	 * Scenarios 2: Login()--> navigate to Organization-->create new organization with industry type-->verify
	 * Scenarios 3: Login()--> navigate to Organization-->create new organization with PhoneNumber-->verify
	 * @throws Throwable
	 */
	...
	public void createOrgWithIndustryTest() throws Throwable {
		...
		/*verification of Organization header msg*/
		UtilityClassObject.getTest().log(Status.INFO, "Verification of organization started!!!");
		OrganizationInformationPage oi=new OrganizationInformationPage(driver);
		String actHeader = oi.getHeadermsg().getText();
	...
	public void createOrgnameWithPhone() throws Throwable
	{
		...
		/*Create new organization and enter all details along with phone number*/
